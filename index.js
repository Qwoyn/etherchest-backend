  ...
  if(state.cs == null) {
    ...
    processor.onBlock(function(num, block) {
        ...
        if (num % 5 === 0 && processor.isStreaming()) {
            ...
            state.stats.prices.listed.gems.diamond = Math.ceil(gemPrice * 1.01);
            state.stats.prices.listed.gems.sapphire = Math.ceil((gemPrice * 1.01) / 2) + 1;
            state.stats.prices.listed.gems.emerald = Math.ceil((gemPrice * 1.01) / 4) + 1;
            state.stats.prices.listed.gems.ruby = Math.ceil((gemPrice * 1.01) / 10) + 1;
            state.bal.c = 0
