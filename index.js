...
var state;
var startingBlock = ENV.STARTINGBLOCK || 48580874; //GENESIS BLOCK
  ...
  if(state.cs == null) {
    ...
    processor.onBlock(function(num, block) {
        ...
        if (num % 5 === 0 && processor.isStreaming()) {
            ...
            state.stats.prices.listed.gems.diamond = Math.ceil(gemPrice * 1.02 * 1000) + 350;
            state.stats.prices.listed.gems.sapphire = Math.ceil((gemPrice * 1.02 * 1000) / 2) + 350;
            state.stats.prices.listed.gems.emerald = Math.ceil((gemPrice * 1.02 * 1000) / 4) + 350;
            state.stats.prices.listed.gems.ruby = Math.ceil((gemPrice * 1.02 * 1000) / 10) + 700;
