  ...
  if(state.cs == null) {
    ...
    processor.onBlock(function(num, block) {
        ...
        if (num % 5 === 0 && processor.isStreaming()) {
            ...
            state.stats.prices.listed.gems.diamond = Math.ceil(gemPrice * 1.02) + 9000;
            state.stats.prices.listed.gems.sapphire = Math.ceil((gemPrice * 1.02) / 2) + 9000;
            state.stats.prices.listed.gems.emerald = Math.ceil((gemPrice * 1.02) / 4) + 9000;
            state.stats.prices.listed.gems.ruby = Math.ceil((gemPrice * 1.02) / 10) + 9000;
