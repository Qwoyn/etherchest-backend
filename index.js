...
var state;
var startingBlock = ENV.STARTINGBLOCK || 48581425; //GENESIS BLOCK
  ...
  if(state.cs == null) {
    ...
    processor.onBlock(function(num, block) {
        ...
        if (num % 5 === 0 && processor.isStreaming()) {
            ...
            state.stats.prices.listed.gems.diamond = Math.ceil(gemPrice * 1.02) + 3000;
            state.stats.prices.listed.gems.sapphire = Math.ceil((gemPrice * 1.02) / 2) + 3000;
            state.stats.prices.listed.gems.emerald = Math.ceil((gemPrice * 1.02) / 4) + 3000;
            state.stats.prices.listed.gems.ruby = Math.ceil((gemPrice * 1.02) / 10) + 8500;
